    ...
    <Container className="mt-24 md:mt-28">
      ...
      <div className="mx-auto grid grid-cols-1 gap-y-10 lg:max-w-none lg:grid-cols-1">
        <div className="space-y-10 w-full">
          <form onSubmit={handleSubmit} className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
            ...
            <div className="mt-6 flex gap-2">
              ...
              />
              {errors.message && <p className="text-red-500 m-2 text-sm">{errors.message}</p>}
            </div>
            <Button type="submit"
              disabled={!isFormValid || isSubmitting}
              className={`submit-button ${(!isFormValid || isSubmitting) ? 'disabled cursor-not-allowed' : ''} flex-none mt-6`}
            >
...
function MailIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M2.75 7.75a3 3 0 0 1 3-3h12.5a3 3 0 0 1 3 3v8.5a3 3 0 0 1-3 3H5.75a3 3 0 0 1-3-3v-8.5Z" className="fill-zinc-100 stroke-zinc-400" />
